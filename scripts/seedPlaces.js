...
const placeData = [
  {
    ...
    description: 'Chuỗi cà phê nổi tiếng với không gian hiện đại, view hồ Hoàn Kiếm tuyệt đẹp. Menu đa dạng từ cà phê truyền thống đến các món signature.',
    photos: [
  ...
  },
  {
    ...
    description: 'Cà phê Highlands với view toàn cảnh thành phố từ tầng cao Lotte Center. Không gian sang trọng, phù hợp cho các cuộc họp quan trọng.',
    photos: [
    ...
    address: {
      street: 'Lotte Center, 54 Liễu Giai',
  ...
  },
  {
    ...
    description: 'Cà phê theo phong cách retro với không khí hoài niệm. Menu đặc trưng với cà phê sữa đá, bạc xỉu và các món ăn vặt truyền thống.',
    photos: [
  ...
  },
  {
    ...
    description: 'Chuỗi cà phê Phúc Long với không gian rộng rãi, phù hợp cho gia đình và nhóm bạn. Nổi tiếng với trà sữa và các món ăn Á.',
    photos: [
      'https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&h=600&fit=crop',
      'https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=800&h=600&fit=crop',
      'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=800&h=600&fit=crop'
  ...
  },
  {
    ...
    description: 'Chuỗi trà sữa Gong Cha với không gian hiện đại, phù hợp cho giới trẻ. Menu đa dạng với các loại trà sữa và topping phong phú.',
    photos: [
      'https://images.unsplash.com/photo-1559925393-8be0ec4767c8?w=800&h=600&fit=crop',
      'https://images.unsplash.com/photo-1447933601403-0c6688de566e?w=800&h=600&fit=crop',
      'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=600&fit=crop'
    ...
    address: {
      street: 'Royal City, 72A Nguyễn Trãi',
  ...
  },
  {
    ...
    description: 'Starbucks với không gian sang trọng, phù hợp cho công việc và gặp gỡ. Menu quốc tế với các loại cà phê đặc biệt.',
    photos: [
      'https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?w=800&h=600&fit=crop',
      'https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&h=600&fit=crop',
      'https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=800&h=600&fit=crop'
    ...
    address: {
      street: 'Vincom Center, 191 Bà Triệu',
  ...
  },
  {
    ...
    description: 'Cà phê Trung Nguyên với không gian truyền thống, phù hợp cho việc thưởng thức cà phê đích thực. Menu đặc trưng với các loại cà phê Việt Nam.',
    photos: [
      'https://images.unsplash.com/photo-1442512595331-e89e73853f31?w=800&h=600&fit=crop',
      'https://images.unsplash.com/photo-1559056199-641a0ac8b55e?w=800&h=600&fit=crop',
      'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=800&h=600&fit=crop'
    ...
    address: {
      street: 'Times City, 458 Minh Khai',
  ...
  },
  {
    ...
    description: 'Cà phê Sài Gòn với không gian ấm cúng, phù hợp cho việc thư giãn và đọc sách. Menu đặc trưng với cà phê sữa đá và các món ăn vặt.',
    photos: [
      'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=600&fit=crop',
      'https://images.unsplash.com/photo-1442512595331-e89e73853f31?w=800&h=600&fit=crop',
      'https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?w=800&h=600&fit=crop'
  ...
  // 20 địa điểm mới ở Hà Nội
  {
    ...
    description: 'Cà phê trứng nổi tiếng Hà Nội với công thức gia truyền. Không gian ấm cúng, phù hợp cho việc thưởng thức cà phê truyền thống.',
    photos: [
      'https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=800&h=600&fit=crop',
      'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=800&h=600&fit=crop'
    ],
    address: {
      street: '39 Nguyễn Hữu Huân',
      ward: 'Phường Hàng Bạc',
      district: 'Hoàn Kiếm',
  ...
  // 1 địa điểm bị từ chối
  {
    ...
    address: {
      street: '123 Đường Không Tồn Tại',
      ward: 'Phường Không Có',
      district: 'Đống Đa',
    ...
    isVerified: false,
    approvalStatus: 'rejected',
    rejectionReason: 'Thông tin địa chỉ không chính xác, số điện thoại không hợp lệ, và thông tin mô tả không đầy đủ. Địa điểm này có vẻ như là spam hoặc thông tin giả mạo.',
    averageRating: 0,
    totalRatings: 0,
    viewCount: 0,
    hotScore: 0,
...
const seedPlaces = async () => {
  try {
    ...
    // Lấy danh sách categories để gán ngẫu nhiên
    ...
    const getCategoriesForPlace = (place) => {
      ...
      if (place.name.includes('Starbucks') || place.name.includes('Highlands') || place.name.includes('The Coffee House')) {
        ...
        const takeaway = categories.find(cat => cat.type === 'service' && cat.name === 'Takeaway');
        const dineIn = categories.find(cat => cat.type === 'service' && cat.name === 'Dine-in');
        const delivery = categories.find(cat => cat.type === 'service' && cat.name === 'Delivery');
      ...
      if (place.description.includes('hiện đại') || place.name.includes('Starbucks') || place.name.includes('Highlands')) {
        const modern = categories.find(cat => cat.type === 'style' && cat.name === 'Hiện đại');
        if (modern) selectedCategories.push(modern);
      } else if (place.description.includes('retro') || place.description.includes('hoài niệm') || place.name.includes('Cộng Cà Phê')) {
        const vintage = categories.find(cat => cat.type === 'style' && cat.name === 'Vintage');
        if (vintage) selectedCategories.push(vintage);
      } else if (place.description.includes('vườn') || place.description.includes('xanh') || place.description.includes('thiên nhiên')) {
        const nature = categories.find(cat => cat.type === 'style' && cat.name === 'Thiên nhiên');
        ...
        const industrial = categories.find(cat => cat.type === 'style' && cat.name === 'Công nghiệp');
      ...
      if (place.description.includes('làm việc') || place.description.includes('học tập') || place.name.includes('Sách')) {
        const work = categories.find(cat => cat.type === 'purpose' && cat.name === 'Làm việc');
        if (work) selectedCategories.push(work);
      } else if (place.description.includes('hẹn hò') || place.description.includes('lãng mạn') || place.description.includes('hoa')) {
        const dating = categories.find(cat => cat.type === 'purpose' && cat.name === 'Hẹn hò');
        if (dating) selectedCategories.push(dating);
      } else if (place.description.includes('gặp gỡ') || place.description.includes('nhóm bạn') || place.description.includes('đối tác')) {
        const meeting = categories.find(cat => cat.type === 'purpose' && cat.name === 'Gặp gỡ');
        if (meeting) selectedCategories.push(meeting);
      } else if (place.description.includes('thư giãn') || place.description.includes('đọc sách') || place.description.includes('yên tĩnh')) {
        const relax = categories.find(cat => cat.type === 'purpose' && cat.name === 'Thư giãn');
    ...
    // Thêm dữ liệu mới
    const places = await Place.insertMany(placesWithCategories);
    ...
    places.forEach(place => {
      const placeCategories = place.categories.map(catId => {
        const category = categories.find(cat => cat._id.toString() === catId.toString());
